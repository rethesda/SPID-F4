...
#pragma endregion
	...
	void Distribute(NPCData& npcData, const PCLevelMult::Input& input, Forms::DistributionSet& forms, bool allowOverwrites, bool onDeath = false, DistributedForms* accumulatedForms = nullptr);
